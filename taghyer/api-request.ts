...
// Run with: npx ts-node api-request.ts
// Or compile and run with: tsc api-request.ts && node api-request.js
...
interface SearchPayload {
  ...
  familyname?: string;
  fullname?: string;
  internal_reference_from?: string;
  internal_reference_to?: string;
  employer?: string;
  team_icon?: string;
  recordPerTime: number;
  start_from: number;
  search_public_elections: number;
}
