...
class ElectionMethodOptions(models.TextChoices):
    CANDIDATE_ORIENTED_SYSTEM = 'candidateOriented', _('Candidate Oriented System')
    PARTY_ORIENTED_SYSTEM = 'partyOriented', _('Party Oriented System')
    PARTY_CANDIDATE_ORIENTED_SYSTEM = 'partyCandidateOriented', _('Party Candidate Oriented System')
    PARTY_CANDIDATE_COMBINED_SYSTEM = 'partyCandidateCombined', _('Party Candidate Combined System')
...
#     CANDIDATE_ONLY = 'candidateOriented', _('Candidate Only')
#     PARTY_ONLY = 'partyOriented', _('Party Only')
