...
// import { addProduct } from 'store/cartActions'; // TODO: Fix missing cartActions
...
export default function ProductCard({ id, color, name, image, description, offerPrice, salePrice, rating }: ProductCardProps) {
  ...
  const addCart = () => {
    // dispatch(addProduct({ id, name, image, salePrice, offerPrice, color, size: 8, quantity: 1 }, cart.checkout.products)); // TODO: Fix missing cartActions
    dispatch(
      openSnackbar({
        open: true,
